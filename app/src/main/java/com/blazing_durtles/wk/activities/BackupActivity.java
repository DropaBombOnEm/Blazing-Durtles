...
public class BackupActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if ("com.blazing_durtles.wk.BACKUP".equals(action)) {
            startBackup();
        } else if ("com.blazing_durtles.wk.RESTORE".equals(action)) {
            startRestore();
        } else {
    ...
    private String generateBackupFilename() {
        ...
        return "blazing_durtles_" + dateFormat.format(new Date()) + ".json";
    }
