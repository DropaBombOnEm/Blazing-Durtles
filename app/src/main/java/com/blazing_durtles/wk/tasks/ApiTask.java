...
package com.blazing_durtles.wk.tasks;
...
import com.blazing_durtles.wk.api.RateLimiter;
import com.blazing_durtles.wk.api.model.WaniKaniEntity;
...
import com.blazing_durtles.wk.livedata.LiveApiProgress;
...
import com.blazing_durtles.wk.util.StreamUtil;
...
import static com.blazing_durtles.wk.Constants.API_RETRY_DELAY;
import static com.blazing_durtles.wk.Constants.HTTP_TOO_MANY_REQUESTS;
import static com.blazing_durtles.wk.Constants.HTTP_UNPROCESSABLE_ENTITY;
import static com.blazing_durtles.wk.Constants.MINUTE;
import static com.blazing_durtles.wk.Constants.NUM_API_TRIES;
import static com.blazing_durtles.wk.Constants.SECOND;
import static com.blazing_durtles.wk.util.ObjectSupport.safe;
import static com.blazing_durtles.wk.util.ObjectSupport.safeNullable;
...
public abstract class ApiTask {
    ...
    /**
     * Subclasses must implement this to perform the actual work of the task.
     */
    protected abstract void runLocal();

    /**
     * Run the task. This is the entry point called by the service.
     */
    public final void run() {
        try {
            runLocal();
        } catch (Exception e) {
            Logger.get(getClass()).error(e, "Error running ApiTask");
        }
    }

    /**
     * Subclasses may override this to indicate if the task can run in the current context.
     * Default is true.
     */
