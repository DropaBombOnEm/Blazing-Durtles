...
public final class DownloadAudioTask extends ApiTask {
    ...
    /**
     * Download a file from a URL to a temporary file, then move to the final output file.
     *
     ...
     */
    private void downloadFile(final String urlString, final File tempFile, final File outputFile) {
        ...
        try {
            ...
            com.blazing_durtles.wk.util.StreamUtil.pump(is, os);
            is.close();
            is = null;
            os.close();
            os = null;
            ...
            // Ignore errors, as per class doc
        }
        finally {
            if (is != null) {
                try { is.close(); } catch (final Exception e) { /* ignore */ }
            }
            if (os != null) {
                try { os.close(); } catch (final Exception e) { /* ignore */ }
            }
        }
    }
}
