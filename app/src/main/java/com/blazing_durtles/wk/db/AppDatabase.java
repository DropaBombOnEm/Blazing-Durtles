...
package com.blazing_durtles.wk.db;
...
import com.blazing_durtles.wk.db.dao.AudioDownloadStatusDao;
import com.blazing_durtles.wk.db.dao.LevelProgressionDao;
import com.blazing_durtles.wk.db.dao.LogRecordDao;
import com.blazing_durtles.wk.db.dao.PropertiesDao;
import com.blazing_durtles.wk.db.dao.SearchPresetDao;
import com.blazing_durtles.wk.db.dao.SessionItemDao;
import com.blazing_durtles.wk.db.dao.SrsSystemDao;
import com.blazing_durtles.wk.db.dao.SubjectAggregatesDao;
import com.blazing_durtles.wk.db.dao.SubjectCollectionsDao;
import com.blazing_durtles.wk.db.dao.SubjectDao;
import com.blazing_durtles.wk.db.dao.SubjectSyncDao;
import com.blazing_durtles.wk.db.dao.SubjectViewsDao;
import com.blazing_durtles.wk.db.dao.TaskDefinitionDao;
import com.blazing_durtles.wk.db.model.AudioDownloadStatus;
import com.blazing_durtles.wk.db.model.LevelProgressionEntityDefinition;
import com.blazing_durtles.wk.db.model.LogRecordEntityDefinition;
import com.blazing_durtles.wk.db.model.PronunciationAudioOwner;
import com.blazing_durtles.wk.db.model.Property;
import com.blazing_durtles.wk.db.model.SearchPreset;
import com.blazing_durtles.wk.db.model.SessionItem;
import com.blazing_durtles.wk.db.model.SrsSystemDefinition;
import com.blazing_durtles.wk.db.model.SubjectEntityDefinition;
import com.blazing_durtles.wk.db.model.TaskDefinition;
import com.blazing_durtles.wk.enums.SessionType;
import com.blazing_durtles.wk.jobs.TickJob;
import com.blazing_durtles.wk.model.Session;
import com.blazing_durtles.wk.services.JobRunnerService;
import com.blazing_durtles.wk.tasks.DownloadAudioTask;
import com.blazing_durtles.wk.tasks.DownloadPitchInfoTask;
import com.blazing_durtles.wk.tasks.GetAssignmentsTask;
import com.blazing_durtles.wk.tasks.GetLevelProgressionTask;
import com.blazing_durtles.wk.tasks.GetPatchedAssignmentsTask;
import com.blazing_durtles.wk.tasks.GetPatchedReviewStatisticsTask;
import com.blazing_durtles.wk.tasks.GetPatchedStudyMaterialsTask;
import com.blazing_durtles.wk.tasks.GetReviewStatisticsTask;
import com.blazing_durtles.wk.tasks.GetSrsSystemsTask;
import com.blazing_durtles.wk.tasks.GetStudyMaterialsTask;
import com.blazing_durtles.wk.tasks.GetSubjectTask;
import com.blazing_durtles.wk.tasks.GetSubjectsTask;
import com.blazing_durtles.wk.tasks.GetSummaryTask;
import com.blazing_durtles.wk.tasks.GetUserTask;
import com.blazing_durtles.wk.tasks.LoadReferenceDataTask;
import com.blazing_durtles.wk.tasks.ReportSessionItemTask;
import com.blazing_durtles.wk.tasks.ScanAudioDownloadStatusTask;
import com.blazing_durtles.wk.tasks.SubmitStudyMaterialTask;
...
import static com.blazing_durtles.wk.util.ObjectSupport.join;
