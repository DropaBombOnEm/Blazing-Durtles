...
package com.blazing_durtles.wk.db.dao;
...
import com.blazing_durtles.wk.tasks.ApiTask;
...
public abstract class TaskDefinitionDao {
     ...
     */
    @Query("DELETE FROM task_definition WHERE taskClass = 'com.blazing_durtles.wk.tasks.DownloadAudioTask'")
     ...
     * @return the number
     */
    @Query("SELECT COUNT(*) FROM task_definition WHERE taskClass!='com.blazing_durtles.wk.tasks.DownloadAudioTask' "
            + "AND taskClass!='com.blazing_durtles.wk.tasks.DownloadPitchInfoTask'")
    ...
    @Query("SELECT apiCount, audioCount, pitchInfoCount FROM "
            ...
            + "WHERE taskClass!='com.blazing_durtles.wk.tasks.DownloadAudioTask' AND taskClass!='com.blazing_durtles.wk.tasks.DownloadPitchInfoTask'), "
            + "(SELECT count(*) AS audioCount FROM task_definition "
            + "WHERE taskClass='com.blazing_durtles.wk.tasks.DownloadAudioTask'), "
            + "(SELECT count(*) AS pitchInfoCount FROM task_definition "
            + "WHERE taskClass='com.blazing_durtles.wk.tasks.DownloadPitchInfoTask');")
