...
import static com.blazing_durtles.wk.StableIds.API_TASK_SERVICE_JOB_ID;
        ...
        while (db.hasPendingApiTasks()) {
            ...
            synchronized (TASK_MONITOR) {
                ...
                if (clas == null) {
                    ...
                    // TODO: Ensure apiTask is of a type that has canRun() and run() methods, or cast/replace as needed.
                    if (!apiTask.canRun()) {
                        break;
                    }
